...
NORMALIZATION_RULES = [
    ...
    {
        "payload": "/interaktiv_role_interest",
        "match": MATCH_CONTAINS,
        "aliases": {
            "warum interaktiv",
            "warum interaktiv gmbh",
            "warum möchtest du zu interaktiv",
            "warum willst du zu interaktiv",
            "was reizt dich an interaktiv",
            "was findest du an interaktiv spannend",
            "warum ki spezialist",
            "warum werkstudent ki spezialist",
        },
    },
    {
        "payload": "/interaktiv_llm_api_approach",
        "match": MATCH_CONTAINS,
        "aliases": {
            "wie würdest du llm apis testen",
            "wie würdest du llm-apis testen",
            "wie vergleichst du llm apis",
            "wie vergleichst du llm-apis",
            "wie testest du llm apis",
            "wie testest du llm-apis",
            "wie testest du openrouter",
            "wie testest du groq",
            "wie testest du google vertex ai",
            "wie würdest du rag bei interaktiv aufbauen",
            "wie würdest du ein rag system implementieren",
            "wie würdest du lokale open source modelle ausprobieren",
            "wie würdest du mistral oder llama testen",
        },
    },
    {
        "payload": "/rag_question",
        "match": MATCH_CONTAINS,
        "aliases": {
            "was ist rag",
            "was bedeutet rag",
            "was verstehst du unter rag",
            "kannst du rag erklären",
            "wie erklärst du rag",
            "warum ist rag spannend",
            "warum findest du rag spannend",
        },
    },
    {
        "payload": "/interaktiv_learning_fit",
        "match": MATCH_CONTAINS,
        "aliases": {
            "was passt an deinem profil zu interaktiv",
            "was bringst du für interaktiv mit",
            "warum passt dein profil zu interaktiv",
            "warum passt du zur ki spezialist stelle",
            "passt dein chatbot projekt zu interaktiv",
            "hast du erfahrung mit llm apis",
            "hast du erfahrung mit rag systemen",
            "hast du erfahrung mit lokalen modellen",
        },
    },
    {
        "payload": "/interaktiv_team_knowledge",
        "match": MATCH_CONTAINS,
        "aliases": {
            "wie bringst du ki wissen ins team",
            "kannst du kurzpräsentationen zu ki halten",
            "kannst du demos zu neuen tools bauen",
            "würdest du interne workshops machen",
            "wie erklärst du technische themen nicht technikern",
            "wie erklärst du generative ai im team",
            "wie erklärst du ki im team",
            "wie erklärst du ki themen im team",
            "wie erklärst du ki-themen im team",
        },
    },
    {
